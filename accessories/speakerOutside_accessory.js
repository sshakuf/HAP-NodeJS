...
var lockUUID = uuid.generate('hap-nodejs:accessories:outsidelock');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake lock.
var lock = exports.accessory = new Accessory('Outside Lock', lockUUID);

getJson("10.0.0.28", '/eport/')


// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
lock.username = "C1:5D:3A:EE:5E:FC";
...
lock
  ...
  .setCharacteristic(Characteristic.SerialNumber, "A1S2NASF88Eq");
...
lock
  .addService(Service.LockMechanism, "Outside Speaker") // services exposed to the user should have "names" like "Fake Light" for us
